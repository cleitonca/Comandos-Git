...
> b) Interfaces gráficas de usuário (GUI - Graphical User Interface) com opções variadas. (<a href="https://git-scm.com/downloads/guis">Clique aqui para visualizar essas interfaces Interfaces</a>)
